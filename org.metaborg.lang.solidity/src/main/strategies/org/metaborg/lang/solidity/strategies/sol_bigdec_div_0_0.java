...
public class sol_bigdec_div_0_0 extends TupleStrategy {
	public static final sol_bigdec_div_0_0 instance = new sol_bigdec_div_0_0();
	
	private sol_bigdec_div_0_0() {}
	...
	public IStrategoTerm call(Context context, IStrategoTerm[] terms) {
		...
		String result = e1.divide(e2).toString();
